...
@Component({
  selector: 'app-pe-for-children-plan',
  templateUrl: './plan.component.html',
  styleUrls: ['../../common/plan-common.component.scss']
})
export class PlanComponent implements OnInit {
  containerConfig: ContainerConfig;
  @select(['pe-for-children-plan', 'data']) data: Observable<any>;
  ...
  handleDayClick(date) {
    this.action.dataChange('pe-for-children-plan', {
      siteId: this.siteId,
      centerId: this.centerId,
      orgName: this.orgName
    });
    this.router.navigate(['/pe-for-children/plan/edit', date, 'tj'], {queryParams: {org: this.siteId || this.centerId}});
  }
